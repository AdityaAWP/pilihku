            ...
            <div class="card">
                <div class="row">
                    ...
                    <div class="col-md-6 p-0">                    
                        <a href="{{ route('super-admin.organizations.create') }}" class="btn btn-primary btn-sm ms-2">+ Tambah</a>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header pb-0">
                    <form action="{{ route('super-admin.organizations.index') }}">
                        <div class="row mb-2">
                            <div class="col-2">
                            ...
                            <tbody>
                                @foreach ($organizations as $value)
                                    <tr>
                                        ...
                                        <td><img src="{{ asset("storage/logo/".$value->logo) }}" alt="logo" style="max-width: 50px; max-height: 50px;"></td>
                                        <td>{{ $value->name }}</td>
                                        <td><a href="{{ env('APP_URL') . '/' . $value->slug }}">{{ env('APP_URL') . '/' . $value->slug }}</a></td>
                                        <td>
                                            <ul class="action"> 
                                                <li class="edit me-2"><a href="{{ route('super-admin.organizations.edit', $value->id) }}" title="Edit Organisasi"><i class="icon-pencil-alt"></i></a></li>
                                                ...
                                                <li class="delete">
                                                    <form action="{{ route('super-admin.organizations.destroy', $value->id) }}" method="post">
                                                        @method('delete')
                                                        @csrf
                                                        <button title="Delete Organisasi" class="border-0" style="background-color: transparent;" onClick="return confirm('Are You Sure')"><i class="icon-trash"></i></button>
                                                    </form>
                                                </li>
                                            </ul>
                                        </td>
